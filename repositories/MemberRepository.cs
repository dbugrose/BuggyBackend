...
namespace BuggyBackend.Repositories
{
    public class MemberRepository : IMemberRepository
    {
        ...
        private void InitializeData()
        {
            _members = new List<Member>
            {
                new Member { Id = 1, Name = "Isaiah Ferguson", Email = "ifergusonlll@sjcoe.net", MembershipDate = DateTime.Now.AddYears(-2), BorrowedBookIds = [] },
                new Member { Id = 2, Name = "Jacob Dekok", Email = "jdekok@sjcoe.net", MembershipDate = DateTime.Now.AddYears(-1), BorrowedBookIds = [] },
                new Member { Id = 3, Name = "Ken Martinez", Email = "jmartenezlopez@sjcoe.net", MembershipDate = DateTime.Now.AddMonths(-6), BorrowedBookIds = [] }
            };
            _nextId = 4;
        }
